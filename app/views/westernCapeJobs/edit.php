...
<div class="body-container container">
    <div class="bhalisa-ngena__form col-md-6">
        <form action="<?php echo URLROOT; ?>/westernCapeJobs/edit/<?php echo $data['id']; ?>" method="post">
        ...
        <form action="<?php echo URLROOT; ?>westernCapeJobs/delete/<?php echo $data['id']; ?>" method="post">
            <div class="input-container flex">
