...
<div class="page container">
    <div class="page-container register-login">
        <h1>Wulungise Apha Lomsebenzi</h1>
    </div>
</div>
<div class="body-container container">
    <div class="bhalisa-ngena__form col-md-6">
        <form action="<?php echo URLROOT; ?>/easternCapeJobs/edit/<?php echo $data['id']; ?>" method="post">
            <div class="form-container">
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <input type="text" name="igama_le_company" id="igama-le-company" class="form-control" value="<?php echo $data['gama_le_company']; ?>" required="required">
                    </div>
                </div>
                <div class="input-label__container">
                    <div class="label-container">
                    ...
                    <div class="input-container flex">
                        <select name="job_province" class="form-control" id="">
                            <option class="form-control" value="<?php echo $data['province']; ?>"><?php echo $data['province']; ?></option>
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <input type="text" name="ndawoni_pha" id="igama-le-company" class="form-control" value="<?php echo $data['ndawoni']; ?>" required="required">
                    </div>
                </div>
                <div class="input-label__container">
                    <div class="label-container">
                    ...
                    <div class="input-container flex">
                        <select name="msebenzi_onjani" class="form-control" id="">
                            <option class="form-control" value="<?php echo $data['msebenzi_onjani']; ?>"><?php echo $data['msebenzi_onjani']; ?></option>
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <select name="mfundo" class="form-control" id="">
                            <option class="form-control" value="<?php echo $data['mfundo']; ?>"><?php echo $data['mfundo']; ?></option>
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <select name="experience" class="form-control" id="">
                            <option class="form-control" value="<?php echo $data['experience']; ?>"><?php echo $data['experience']; ?></option>
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <select name="ngowantoni" class="form-control" id="">
                            <option class="form-control" value="<?php echo $data['ngowantoni']; ?>"><?php echo $data['ngowantoni']; ?></option>
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <textarea name="requirements" rows="10" id="requirements" class="form-control" required="required"><?php echo $data['requirements']; ?></textarea>
                        <script>
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <textarea name="skills_competencies" rows="10" id="skills_competencies" class="form-control"><?php echo $data['skills_competencies']; ?></textarea>
                        <script>
                            // Replace the <textarea id="editor1"> with a CKEditor
                            // instance, using default configuration.
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <textarea name="responsibilities" rows="10" id="responsibilities" class="form-control" required="required"><?php echo $data['responsibilities']; ?></textarea>
                        <script>
                            // Replace the <textarea id="editor1"> with a CKEditor
                            // instance, using default configuration.
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <textarea name="additional_info" rows="10" id="closing_date" class="form-control"><?php echo $data['additional_info']; ?></textarea>
                    </div>
                </div>
                <div class="input-label__container">
                    <div class="label-container">
                ...
                <div class="input-label__container">
                    <div class="row">
                        <div class="input-container col">
                            <button class="form-btn__primary btn btn-dark">Cofa xa Ugqibile</button>
                        </div>
                    </div>
                </div>
            </div>
        </form>
        <form action="<?php echo URLROOT; ?>easternCapeJobs/delete/<?php echo $data['id']; ?>" method="post">
            <div class="input-container flex">
