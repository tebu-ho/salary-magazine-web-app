        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card card-body bg-light md-5">
                    <form action="<?php echo URLROOT; ?>izaziso/edit/<?php echo $data['id']; ?>" method="post">
                        <div class="form-container">
                            ...
                            <div class="input-label__container mt-3">
                                ...
                                <div class="input-container">
                                    <textarea rows="10" name="isaziso" id="isaziso" class="form-control <?php echo (!empty($data['isaziso_err'])) ? 'is-invalid' : ''; ?>" required="required"><?php echo $data['isaziso']; ?></textarea>
                    ...
                    <form action="<?php echo URLROOT; ?>izaziso/delete/<?php echo $data['id']; ?>" method="post">
                        <div class="input-container flex">
