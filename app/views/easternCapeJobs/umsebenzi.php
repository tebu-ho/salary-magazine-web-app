...
<div class="main-content">
    <div class="page container">
        <div class="page-container">
            <a href="<?php echo URLROOT; ?>easternCapeJobs"><i class="fas fa-angle-double-left"></i> <span>Buyela emva</span></a>
        </div>
    </div>
        ...
        <div class="center-side col-md-6">
            <div class="card-lo-msebenzi cofa-card-lo__msebenzi heading-container">
                ...
                <div class="description-yo__msebenzi">
                    ...
                    <p class="requirements">Skills &amp; Competencies</p>
                        <?php echo $data['umsebenzi']->skills_competencies; ?>
                    <?php endif; ?>
