...
<div class="main-content">
    <div class="page container">
        <div class="page-container">
            <a href="<?php echo URLROOT; ?>northernCapeJobs"><i class="fas fa-angle-double-left"></i> <span>Buyela emva</span></a>
        </div>
    </div>
    <div class="body-container container">
        <?php require APPROOT .'/views/inc/right-sidebar.php'; ?>
        <div class="center-sidecol-md-6">
            <div class="card-lo-msebenzi cofa-card-lo__msebenzi heading-container">
                <div class="card-lo-msebenzi__container">
                    ...
                    <p>Closing date yi <?php echo $date->convertDayDate($data['umsebenzi']->created_at); ?> ka <?php echo $date->convertMonthYear($data['umsebenzi']->created_at); ?></p>
                </div>
                <div class="description-yo__msebenzi">
                    <p class="requirements">Requirements</p><?php echo $data['umsebenzi']->requirements; ?>
                    ...
                    <div class="apply">
                    <a href="<?php echo $data['umsebenzi']->application_mode; ?>" class="job-search__btn">Apply kwi website yale company</a>
                    </div>
