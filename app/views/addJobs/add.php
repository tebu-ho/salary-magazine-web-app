...
<div class="body-container container">
    <div class="bhalisa-ngena__form col-md-6">
        ...
        <form action="<?php echo URLROOT; ?>addJobs/add" method="post">
            <div class="form-container">
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <select name="job_province" class="form-control" id="">
                            <?php echo $option->selectOption(); var_dump($option);?>
                ...
                <div class="input-label__container">
                    ...
                    <div class="input-container flex">
                        <textarea name="requirements" id="requirements" class="form-control" required="required">
