...
<div class="main-content">
    <div class="page container">
        <div class="page-container">
            <a href="<?php echo URLROOT; ?>imithandazo"><i class="fas fa-angle-double-left"></i> <span>Buyela emva</span></a>
        </div>
        <div class="page-container">
            <h1>Phendula Apha</h1>
        </div>
        ...
        <div class="center-side profile-content">
            <div class="card-lo-msebenzi heading-container timeline-card">
                ...
                <div class="content-container">
                    <div class="content">
                        <p><?php echo $data['umthandazo']; ?></p>
                    </div>
                </div>
                <div class="label-container">
                    <label for="imithandazo">Comments</label>
                </div>
                ...
                <?php if (isset($_SESSION['id_yomntu'])) { ?>
                    <div class="label-container mt-3">
                        <label for="imithandazo"><a data-toggle="collapse" href="#impendulo" role="button" aria-expanded="false" aria-controls="impendulo">Phendula apha</a></label>
                    </div>
                    <form class="collapse" id="impendulo" action="<?php echo URLROOT; ?>imithandazo/phendula/<?php echo $data['id'] ?>" method="post">
