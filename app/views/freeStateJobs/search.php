...
<div class="page container search-province">
    <div class="page-container">
        <h1>Free State Results</h1>
    </div>
    <div class="page-container page-container__search">
        <form action="<?php echo URLROOT; ?>freeStateJobs/search" method="GET" class="form-inline">
                ...
                <?php foreach ($data['imisebenzi'] as $umsebenzi): ?>
                    <div class="card-lo-msebenzi heading-container">
                        <div class="job-title__index">
                            <a href="<?php echo URLROOT; ?>freeStateJobs/umsebenzi/<?php echo $umsebenzi->slug; ?>" class="umsebenzi-card__title">
                                <h6>
                            ...
                            <?php if (isset($_SESSION['id_yomntu']) && $umsebenzi->id_yomntu == $_SESSION['id_yomntu']) : ?>
                                <div class="follow">
                                    <a href="<?php echo URLROOT; ?>freeStateJobs/edit/<?php echo $umsebenzi->slug; ?>" class="edit-link follow-btn">Edit</a>
                                </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="description-yo__msebenzi">
                            ...
                            <a href="<?php echo URLROOT; ?>freeStateJobs/umsebenzi/<?php echo $umsebenzi->slug; ?>" style="font-weight: 600">Cofa apha</a>
                        </div>
                    </div>
                <?php endforeach; ?>
                <div>
