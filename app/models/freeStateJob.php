...
class freeStateJob
{
    ...
    public function getImisebenzi()
    {
        $this->db->query(
            ...
            WHERE imisebenzi.province = "Free State"
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            'SELECT * FROM
            imisebenzi WHERE province = "Free State"
            AND gama_le_company LIKE :search
            OR province = "Free State" AND ndawoni LIKE :search
            OR province = "Free State" AND job_title LIKE :search
            OR province = "Free State" AND ngowantoni LIKE :search
            OR province = "Free State" AND mfundo LIKE :search
            OR province = "Free State" AND responsibilities LIKE :search
            OR province = "Free State" AND skills_competencies LIKE :search
            OR province = "Free State" AND requirements LIKE :search
            OR province = "Free State" AND additional_info LIKE :search
            ORDER BY imisebenzi.created_at DESC
         ');
