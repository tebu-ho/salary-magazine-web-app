                ...
                <?php echo flash('message_yomsebenzi'); ?>
                    <?php foreach ($data['imisebenzi'] as $umsebenzi): ?>
                        <div class="card-lo-msebenzi heading-container">
                            <div>
                                <a href="<?php echo URLROOT; ?>northWestJobs/umsebenzi/<?php echo $umsebenzi->slug; ?>" class="umsebenzi-card__title">
                                    <h6>
                            ...
                            <div class="description-yo__msebenzi">
                                ...
                                <a href="<?php echo URLROOT; ?>northWestJobs/umsebenzi/<?php echo $umsebenzi->slug; ?>" style="font-weight: 600">Cofa apha</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
