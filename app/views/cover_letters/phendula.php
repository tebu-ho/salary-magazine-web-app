...
<div class="main-content">
    <div class="page container">
        <div class="page-container">
            <a href="<?php echo URLROOT; ?>cover_letters"><i class="fas fa-angle-double-left"></i> <span>Buyela emva</span></a>
        </div>
        <div class="page-container">
            <h1>Phendula Apha</h1>
        </div>
    ...
    <div class="body-container container">
        ...
        <div class="center-side profile-content">
            <div class="card-lo-msebenzi heading-container timeline-card">
                <?php echo flash('message_yempendulo'); ?>
                <div class="user-feed__meta card-header">
                    <div class="avatar-container">
                        <h5><?php echo $data['igama']; ?></h5>
                    </div>
                    <div class="avatar-container">
                ...
                <div class="content-container">
                    <div class="content">
                        <p><?php echo $data['cover_letter']; ?></p>
                    </div>
                </div>
                <div class="label-container">
                    <label for="cover_letters">Comments</label>
                </div>
                ...
                <?php if (isset($_SESSION['id_yomntu'])) { ?>
                    <div class="label-container mt-3">
                        <label for="cover_letters"><a data-toggle="collapse" href="#impendulo" role="button" aria-expanded="false" aria-controls="impendulo">Phendula apha</a></label>
                    </div>
                    <form class="collapse" id="impendulo" action="<?php echo URLROOT; ?>cover_letters/phendula/<?php echo $data['id'] ?>" method="post">
