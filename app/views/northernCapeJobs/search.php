...
<div class="main-content">
    <div class="page container search-province">
        <div class="page-container">
            <h1>Northern Cape Results</h1>
        </div>
        <div class="page-container page-container__search">
            <form action="<?php echo URLROOT; ?>mpumalangaJobs/search" method="GET" class="form-inline">
            ...
            <?php echo flash('message_yomsebenzi'); ?>
                <?php foreach ($data['imisebenzi'] as $umsebenzi): ?>
                    <div class="card-lo-msebenzi heading-container">
                        <div>
                            <a href="<?php echo URLROOT; ?>northernCapeJobs/umsebenzi/<?php echo $umsebenzi->slug; ?>" class="umsebenzi-card__title">
                                <h6>
                        ...
                        <div class="description-yo__msebenzi">
                            ...
                            <a href="<?php echo URLROOT; ?>northernCapeJobs/umsebenzi/<?php echo $umsebenzi->slug; ?>" style="font-weight: 600">Cofa apha</a>
                        </div>
                    </div>
                <?php endforeach; ?>
