...
class kwaZuluNatalJob
{
    ...
    public function getImisebenzi()
    {
        $this->db->query(
            ...
            WHERE imisebenzi.province = "KwaZulu-Natal"
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            'SELECT * FROM
            imisebenzi WHERE province = "KwaZulu-Natal"
            AND gama_le_company LIKE :search
            OR province = "KwaZulu-Natal" AND ndawoni LIKE :search
            OR province = "KwaZulu-Natal" AND job_title LIKE :search
            OR province = "KwaZulu-Natal" AND ngowantoni LIKE :search
            OR province = "KwaZulu-Natal" AND mfundo LIKE :search
            OR province = "KwaZulu-Natal" AND responsibilities LIKE :search
            OR province = "KwaZulu-Natal" AND skills_competencies LIKE :search
            OR province = "KwaZulu-Natal" AND requirements LIKE :search
            OR province = "KwaZulu-Natal" AND additional_info LIKE :search
            ORDER BY imisebenzi.created_at DESC
         ');
