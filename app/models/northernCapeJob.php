...
class northernCapeJob
{
    ...
    public function getImisebenzi()
    {
        $this->db->query(
            ...
            WHERE imisebenzi.province = "Northern Cape"
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            'SELECT * FROM
            imisebenzi WHERE province = "Northern Cape"
            AND gama_le_company LIKE :search
            OR province = "Northern Cape" AND ndawoni LIKE :search
            OR province = "Northern Cape" AND job_title LIKE :search
            OR province = "Northern Cape" AND ngowantoni LIKE :search
            OR province = "Northern Cape" AND mfundo LIKE :search
            OR province = "Northern Cape" AND responsibilities LIKE :search
            OR province = "Northern Cape" AND skills_competencies LIKE :search
            OR province = "Northern Cape" AND requirements LIKE :search
            OR province = "Northern Cape" AND additional_info LIKE :search
            ORDER BY imisebenzi.created_at DESC
         ');
