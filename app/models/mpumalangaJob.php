...
class mpumalangaJob
{
    ...
    public function getImisebenzi()
    {
        $this->db->query(
            ...
            WHERE imisebenzi.province = "Mpumalanga"
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            'SELECT * FROM
            imisebenzi WHERE province = "Mpumalanga"
            AND gama_le_company LIKE :search
            OR province = "Mpumalanga" AND ndawoni LIKE :search
            OR province = "Mpumalanga" AND job_title LIKE :search
            OR province = "Mpumalanga" AND ngowantoni LIKE :search
            OR province = "Mpumalanga" AND mfundo LIKE :search
            OR province = "Mpumalanga" AND responsibilities LIKE :search
            OR province = "Mpumalanga" AND skills_competencies LIKE :search
            OR province = "Mpumalanga" AND requirements LIKE :search
            OR province = "Mpumalanga" AND additional_info LIKE :search
            ORDER BY imisebenzi.created_at DESC
         ');
