...
class westernCapeJob
{
    ...
    public function getImisebenzi()
    {
        $this->db->query(
            ...
            WHERE imisebenzi.province = "Western Cape"
    ...
    {
        $this->db->query("DELETE FROM imisebenzi WHERE slug = :id");
        $this->db->bind(':id', $id);
        echo $id;
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            'SELECT * FROM
            imisebenzi WHERE province = "Western Cape"
            AND gama_le_company LIKE :search
            OR province = "Western Cape" AND ndawoni LIKE :search
            OR province = "Western Cape" AND job_title LIKE :search
            OR province = "Western Cape" AND ngowantoni LIKE :search
            OR province = "Western Cape" AND mfundo LIKE :search
            OR province = "Western Cape" AND responsibilities LIKE :search
            OR province = "Western Cape" AND skills_competencies LIKE :search
            OR province = "Western Cape" AND requirements LIKE :search
            OR province = "Western Cape" AND additional_info LIKE :search
            ORDER BY imisebenzi.created_at DESC
         ');
