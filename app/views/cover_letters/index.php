                ...
                <div class="card-lo-msebenzi heading-container card-lokubuza">
                    <div class="user-feed__meta">
                        <div class="avatar-link">
                            Cofa apha if ufuna ukubhala i-cover letter yakho.&nbsp;<a href="<?php echo URLROOT .'cover_letters/bhala'; ?>">Cofa apha</a>
                        </div>
                    </div>
                </div>
                ...
                <?php foreach ($data['cover_letter'] as $cover_letter): ?>
                    <div class="card-lo-msebenzi heading-container timeline-card">
                        <div class="user-feed__meta">
                            ...
                            <div class="avatar-container">
                                <a href='<?php echo URLROOT ."cover_letters/phendula/$cover_letter->cover_letterId"; ?>'>&nbsp;<span class="timeline-date"><?php echo $date->convertDayDate($cover_letter->ibhalwe_nini); ?> ka <?php echo $date->convertMonthYear($cover_letter->ibhalwe_nini); ?></span></a>
                            </div>
                            <?php if (isset($_SESSION['id_yomntu']) && $cover_letter->id_yomntu == $_SESSION['id_yomntu']) : ?>
                                <div class="follow">
                                    <a href="<?php echo URLROOT; ?>cover_letters/edit/<?php echo $cover_letter->cover_letterId; ?>" class="edit-link follow-btn">Edit</a>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="content-container">
                            <div class="content">
                                <p><?php echo $cover_letter->cover_letter; ?></p>
                            </div>
                            <div class="social-commentary">
                                <div class="user-to__do">
                                    <a href='<?php echo URLROOT ."cover_letters/phendula/$cover_letter->cover_letterId"; ?>'>
