...
class easternCapeJob
{
    ...
    public function searchImisebenzi($data)
    {
        $this->db->query(
            'SELECT * FROM
            imisebenzi WHERE province = "Eastern Cape"
            AND gama_le_company LIKE :search
            OR province = "Eastern Cape" AND ndawoni LIKE :search
            OR province = "Eastern Cape" AND job_title LIKE :search
            OR province = "Eastern Cape" AND ngowantoni LIKE :search
            OR province = "Eastern Cape" AND mfundo LIKE :search
            OR province = "Eastern Cape" AND responsibilities LIKE :search
            OR province = "Eastern Cape" AND skills_competencies LIKE :search
            OR province = "Eastern Cape" AND requirements LIKE :search
            OR province = "Eastern Cape" AND additional_info LIKE :search
            ORDER BY imisebenzi.created_at DESC
         ');
