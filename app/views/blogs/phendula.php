...
<div class="main-content">
    <div class="page container">
        <div class="page-container">
            <a href="<?php echo URLROOT; ?>blogs"><i class="fas fa-angle-double-left"></i> <span>Buyela emva</span></a>
        </div>
        <div class="page-container">
            <h1>Phendula Apha</h1>
        </div>
        ...
        <div class="center-side profile-content">
            <div class="card-lo-msebenzi heading-container timeline-card">
                ...
                <?php if (isset($_SESSION['id_yomntu'])) { ?>
                    ...
                    <form class="collapse" id="impendulo" action="<?php echo URLROOT; ?>blogs/phendula/<?php echo $data['id'] ?>" method="post">
